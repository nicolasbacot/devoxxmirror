...
public class DevoxxJSONReader {
	...
	private final static String URL_SCHEDULE = "https://cfp.devoxx.com/rest/v1/events/8/schedule/day/";
	
	
	private static InputStream getURLInputStream(String url)
	...
	public static ScheduledSession[][] readSchedule(){
		...
		for (int i = 0 ; i < NB_DAYS ; i++){
			out[i] = loadFromURL(ScheduledSession[].class, URL_SCHEDULE + String.valueOf(i + 1));
		}
		return out;
	}

	public static <T> T loadFromInputStream(Class<T> type, InputStream is) {
		T out = null;
